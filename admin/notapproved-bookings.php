...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Not Approved Bookings </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"> Not Approved Booking History</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Not Approved Booking History</span>
      ...
      ?>  
                                        ...
                                        <tr>
                                            <td> <b><?php echo htmlentities($cnt);?></b></td>
                                              <td><a href="editclient.php?Client_ID=<?php echo htmlentities($result->id);?>" target="_blank"><?php echo htmlentities($result->FirstName." ".$result->LastName);?>(<?php echo htmlentities($result->Cl_Id);?>)</a></td>
