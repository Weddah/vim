...
{
$id=$_GET['del'];
$sql = "delete from  tbleventype  WHERE id=:id";
$query = $dbh->prepare($sql);
$query -> bindParam(':id',$id, PDO::PARAM_STR);
$query -> execute();
$msg="Event type record deleted";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Manage Event Type</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Manage Event Type</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Event Type Info</span>
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT * from tbleventype";
$query = $dbh -> prepare($sql);
$query->execute();
